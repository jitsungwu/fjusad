...
public class News_international extends ListActivity {
    ...
    private void setupViewComponent() {
        mTxtResult = (TextView)findViewById(R.id.news_international);
        
        ArrayAdapter<CharSequence> adapAllvotelist = ArrayAdapter.createFromResource(
				this, R.array.news_international, android.R.layout.simple_list_item_1);
