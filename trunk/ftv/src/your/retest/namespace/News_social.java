...
public class News_social extends ListActivity {
    ...
    private void setupViewComponent() {
        mTxtResult = (TextView)findViewById(R.id.news_social);
        
        ArrayAdapter<CharSequence> adapAllvotelist = ArrayAdapter.createFromResource(
				this, R.array.news_social, android.R.layout.simple_list_item_1);
