...
public class News_finance extends ListActivity {
    ...
    private void setupViewComponent() {
        mTxtResult = (TextView)findViewById(R.id.news_finance);
        
        ArrayAdapter<CharSequence> adapAllvotelist = ArrayAdapter.createFromResource(
				this, R.array.news_finance, android.R.layout.simple_list_item_1);
